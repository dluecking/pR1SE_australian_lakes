...
--wait-for-files '/home/dlueckin/projects/pR1SE_australian_lakes/generate_protein_clusters/.snakemake/tmp.nr4716l2' 'initial_proteins/ORF6_initial_proteins.faa' --latency-wait 50 \
...
--mode 2  --default-resources "tmpdir=system_tmpdir"  && touch /home/dlueckin/projects/pR1SE_australian_lakes/generate_protein_clusters/.snakemake/tmp.nr4716l2/0.jobfinished || (touch /home/dlueckin/projects/pR1SE_australian_lakes/generate_protein_clusters/.snakemake/tmp.nr4716l2/0.jobfailed; exit 1)
