...
--wait-for-files '/home/dlueckin/projects/pR1SE_australian_lakes/generate_protein_clusters/.snakemake/tmp.jx89qbbz' 'initial_proteins/ORF6_initial_proteins.faa' --latency-wait 50 \
...
--mode 2  --default-resources "tmpdir=system_tmpdir"  && touch /home/dlueckin/projects/pR1SE_australian_lakes/generate_protein_clusters/.snakemake/tmp.jx89qbbz/0.jobfinished || (touch /home/dlueckin/projects/pR1SE_australian_lakes/generate_protein_clusters/.snakemake/tmp.jx89qbbz/0.jobfailed; exit 1)
