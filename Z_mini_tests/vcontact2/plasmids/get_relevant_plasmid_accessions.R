...
# NCBI search term:
# "archaeal"[Organism] OR "Archaea"[Organism]) AND "plasmid"[Filter] AND "1"[SLEN]:"50000"[SLEN] NOT "MAG"[All Fields] NOT "shotgun"[All Fields] 

# Read the file into a character vector
file_lines <- readLines("~/Downloads/nuccore_result.txt")
