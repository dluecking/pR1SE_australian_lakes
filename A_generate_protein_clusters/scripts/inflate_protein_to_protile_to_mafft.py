...
parser = argparse.ArgumentParser(
    description='Protein sequence analysis script')
parser.add_argument('--protein_file', required=True,
                    help='Path to protein fasta file (e.g. ORF42.faa)')
parser.add_argument('--output_file', required=True,
                    help='Path of the final alignment file (e.g. path/to/file/ORF42.msa)')
...
try:
    ...
    hmmsearch_command = f'hmmsearch --domtblout {hmmsearch_result_file} --cpu 24 {profile_file} {args.database_path}'
    print('# STEP 3 #################################')
